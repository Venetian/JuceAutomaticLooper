...
//    midiViewValue.addListener(this);
    ...
    moogLoopModeBox.addItem("RECORDING LOOP", 2);
    moogLoopModeBox.addItem("STEP SEQUENCER", 3);
    moogLoopModeBox.addItem("MODULATE", 4);
    moogLoopModeBox.setSelectedItemIndex(0);
	//const StringArray midiLooperOutputs (MidiOutput::getDevices());
	//midiLooperOutputBox.addItemList (midiLooperOutputs, 1);
